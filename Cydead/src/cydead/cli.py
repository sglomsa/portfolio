...
print_game_dir_parser = subparsers.add_parser(
    ...
    help="prints out the path to the set RDR2 game directory")
...
create_profile_parser.add_argument(
    ...
    help="make a description of the profile")
...
set_profiles_dir_parser = subparsers.add_parser(
    ...
    help="sets the directory where profiles will be stored")
...
delete_profile_parser = subparsers.add_parser("delete-profile",
                                              help="deletes a profile")
delete_profile_parser.add_argument("profile_name", type=str,
...
update_profile_parser = subparsers.add_parser(
    "update-profile", help="updates a profile after changes have been made")
update_profile_parser.add_argument("profile_name", type=str,
                                   help="the name of the profile to update")
update_profile_parser.set_defaults(func=cmds.update_profile)
